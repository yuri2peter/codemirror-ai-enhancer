...
KnowLink is a web app that uses AI to automatically manage your personal notes and bookmarks.
...
`chrome` is needed for puppeteer and the executable path is `/usr/bin/chromium-browser`.

On Linux, you can install it via `sudo apt install -y chromium`.
